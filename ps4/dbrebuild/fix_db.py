...
ftp = FTP()
ftp.connect(PS4_IP, 2121, timeout=30)
...
for tbl in tables :
	...
	for tmp_GameID in list_id :
		...
		if(cusa.is_usable == True) :
			sql_list.append("""("%s", "%s", "%s", "/user/appmeta/%s", "2018-07-27 15:06:46.822", "0", "0", "5", "1", "100", "0", "151", "5", "1", "gd", "0", "0", "0", "0", NULL, NULL, NULL, "%d", "2018-07-27 15:06:46.802", "0", "game", NULL, "0", "0", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "0", NULL, NULL, NULL, NULL, NULL, "0", "0", NULL, "2018-07-27 15:06:46.757", null, null, null, null, null, null)"""
	...
	if(len(sql_list) > 0) :
		print ("INSERT INTO %s VALUES %s;"  % (tbl[0], ', '.join(sql_list)))
